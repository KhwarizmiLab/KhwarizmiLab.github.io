...
<a class="featured-media-logo" href="https://www.futura-sciences.com/en/you-thought-expired-bank-cards-were-useless-this-clever-trick-proves-otherwise_38088/" target="_blank" rel="noopener noreferrer" aria-label="Read the Futura coverage"><img src="{{ '/images/media-logos/Futura.svg' | relative_url }}" alt="Futura"></a>
<a class="featured-media-logo" href="https://thehackernews.com/2026/08/zombie-card-attack-can-revive-expired.html" target="_blank" rel="noopener noreferrer" aria-label="Read The Hacker News coverage"><img src="{{ '/images/media-logos/TheHackerNews.png' | relative_url }}" alt="The Hacker News"></a>
<a class="featured-media-logo" href="https://www.repubblica.it/tecnologia/2026/08/21/news/zombie_card_errore_carte_di_credito_scadute_visa-425539948/" target="_blank" rel="noopener noreferrer" aria-label="Read the la Repubblica coverage"><img src="{{ '/images/media-logos/LaRepubblica.png' | relative_url }}" alt="la Repubblica"></a>
<a class="featured-media-logo" href="https://www.securityweek.com/in-other-news-zombie-card-attack-t-mobile-cut-cable-to-stop-hackers-github-denies-ai-caused-bug/" target="_blank" rel="noopener noreferrer" aria-label="Read the SecurityWeek coverage"><img src="{{ '/images/media-logos/SecurityWeek.png' | relative_url }}" alt="SecurityWeek"></a>
<a class="featured-media-logo" href="https://rhisac.org/general-blog/zombie-card-attack-exploits-contactless-payments-for-pos-terminals/" target="_blank" rel="noopener noreferrer" aria-label="Read the RH-ISAC coverage"><img src="{{ '/images/media-logos/RH-ISAC.svg' | relative_url }}" alt="RH-ISAC"></a>
<a class="featured-media-logo" href="https://www.lesnumeriques.com/banque-en-ligne/cartes-de-credit-zombies-des-chercheurs-arrivent-a-payer-sans-contact-avec-des-cartes-visa-perimees-n260595.html" target="_blank" rel="noopener noreferrer" aria-label="Read the Les Numériques coverage"><img src="{{ '/images/media-logos/LesNumeriques.svg' | relative_url }}" alt="Les Numériques"></a>
<a class="featured-media-logo" href="https://www.wwlp.com/news/local-news/zombie-credit-cards-umass-study-uncovers-fraud-risk/" target="_blank" rel="noopener noreferrer" aria-label="Read the WWLP 22News coverage"><img src="{{ '/images/media-logos/WWLP.png' | relative_url }}" alt="WWLP 22News"></a>
</div>
